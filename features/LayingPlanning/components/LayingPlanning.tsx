...
export const LayingPlanning = () => {
    const { data, isLoading } = useLayingPlanning();
    ...
    return (
        <div className="p-8 bg-white rounded-2xl border border-zinc-100 transition-all">
            <div className="flex items-center gap-4 mb-6 text-[#111827]">
                ...
                <div>
                    <h2 className="text-xl font-bold tracking-tight">LayingPlanning</h2>
                    <p className="text-zinc-500 text-xs font-medium">Part of LayingPlanning module</p>
                </div>
            </div>
